...
"[project]/src/app/[lang]/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
function Home() {
    const [isHeaderReady, setIsHeaderReady] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [mounted, setMounted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setMounted(true);
        // Задержка перед рендером хедера, чтобы предотвратить скачки
        const timer = setTimeout(()=>{
            setIsHeaderReady(true); // Теперь можно рендерить хедер
        }, 200); // Можно настроить задержку
        return ()=>clearTimeout(timer);
    }, []);
    if (!mounted || !isHeaderReady) {
        return null; // Не рендерим хедер, пока не загрузится
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4c60eef5._.js.map