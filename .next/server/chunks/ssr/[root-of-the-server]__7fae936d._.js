...
;
;
function Button({ children, className, variant = 'default', size = 'md', isLoading = false, disabled, leftIcon, rightIcon, ...props }) {
    const base = 'inline-flex items-center justify-center gap-2 rounded transition-all focus:outline-none focus:ring-2 focus:ring-black';
    const variants = {
        default: 'bg-gray-100 hover:bg-gray-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-black dark:text-white',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7fae936d._.js.map