...
function Button({ children, className, variant = 'default', size = 'md', isLoading = false, leftIcon, rightIcon, active = false, asChild = false, href, target, rel, ...props }) {
    ...
    if (href && !asChild && typeof href === 'string') {
        try {
            const parsedUrl = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$url$2d$parse$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](href, window?.location?.origin || 'http://localhost');
...
//# sourceMappingURL=src_95f6bc66._.js.map